...
<main>
    <div class="content">
        <div class="buttons">
            <a href="../../frontend/html/favorite.php" class="spinner-link"><button class="favorite">Favorite</button></a>
